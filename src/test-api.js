...
Provide clear, step-by-step fix instructions for only for primary errors in plain language. Format your response in a well-organized, good-looking format (using numbered steps, bullet points, headings, etc.), but do NOT include the complete fixed code.
...
temp.cpp:3:32: error: expected '}' at end of input
    3 |     std::cout << "Hello World";
      |                                ^
temp.cpp:2:12: note: to match this '{'
    2 | int main() {
      |            ^
...
`;
    ...
    await getFixSteps(codeSnippet, errorMsg);
}
...
//         // Modified output to match test-api.js format
//         console.log("FIX INSTRUCTIONS:");
//         console.log(fixSteps);
//     } catch (error) {
//         console.error(`⚠️ Error: ${error.message}`);
